...
fdescribe('PostDetailComponent', () => {
  ...
  */
  ...
  beforeEach(() => {
    ...
    htmlElement = el.query(By.css('h2')).nativeElement as HTMLElement;
    postService.getPost.and.returnValue(of(POSTS[2]));
    location.back.and.returnValue('');
    fixture.detectChanges();
  });

  it('should render the post title in the h2 template',() => { //   fakeAsync(
    //fixture.detectChanges();
    //flush();
    //const h2Content = el.query(By.css("h2"));
    //const element = fixture.debugElement.query(By.css('h2')).nativeElement as HTMLElement;
    //fixture.detectChanges();
    //flush();
    //expect(h2Content.nativeElement.textContent).toContain("title 3");
  expect(htmlElement.textContent).toBe(fixture.componentInstance.post.title);
  }); //)
